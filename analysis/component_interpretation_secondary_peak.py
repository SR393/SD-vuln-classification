...
def get_metrics(repeat, n_samples, alphas, eps, x_grid, x1_ind, comp_1_projection_quantiles_SD, comp_2_projection_quantiles_SD, both_components_projection_quantiles_SD, emp_secondary_peak_locs_SD, emp_left_tail_mass_SD):
    ...
    comp_1_SD_sp_loc_correlation = np.corrcoef(secondary_peak_locs_comp_1_SD[comp_1_correct_sp_inds], emp_secondary_peak_locs_SD[comp_1_correct_sp_inds])[0, 1]
    comp_1_SD_left_tail_mass_correlation = np.corrcoef(comp_1_left_tail_mass_SD[comp_1_correct_sp_inds], emp_left_tail_mass_SD[comp_1_correct_sp_inds])[0, 1]
    ...
    comp_2_SD_sp_loc_correlation = np.corrcoef(secondary_peak_locs_comp_2_SD[comp_2_correct_sp_inds], emp_secondary_peak_locs_SD[comp_2_correct_sp_inds])[0, 1]
    comp_2_SD_left_tail_mass_correlation = np.corrcoef(comp_2_left_tail_mass_SD[comp_2_correct_sp_inds], emp_left_tail_mass_SD[comp_2_correct_sp_inds])[0, 1]
    ...
    both_SD_sp_loc_correlation = np.corrcoef(secondary_peak_locs_both_SD[both_correct_sp_inds], emp_secondary_peak_locs_SD[both_correct_sp_inds])[0, 1]
    both_SD_left_tail_mass_correlation = np.corrcoef(both_left_tail_mass_SD[both_correct_sp_inds], emp_left_tail_mass_SD[both_correct_sp_inds])[0, 1]
    both_SD_proportion_correct = both_proportion_correct

    return comp_1_SD_sp_loc_correlation, comp_1_SD_left_tail_mass_correlation, comp_1_SD_proportion_correct, \
           comp_2_SD_sp_loc_correlation, comp_2_SD_left_tail_mass_correlation, comp_2_SD_proportion_correct, \
           both_SD_sp_loc_correlation, both_SD_left_tail_mass_correlation, both_SD_proportion_correct
