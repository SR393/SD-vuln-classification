...
for repeat in range(n_repeats):
    ...
    comp_1_BL_correlations[repeat] = np.corrcoef(peak_widths_comp_1_BL, emp_peak_widths_BL)[0, 1]
    ...
    comp_1_SD_correlations[repeat] = np.corrcoef(peak_widths_comp_1_SD, emp_peak_widths_SD)[0, 1]
    ...
    comp_2_BL_correlations[repeat] = np.corrcoef(peak_widths_comp_2_BL, emp_peak_widths_BL)[0, 1]
    ...
    comp_2_SD_correlations[repeat] = np.corrcoef(peak_widths_comp_2_SD, emp_peak_widths_SD)[0, 1]
